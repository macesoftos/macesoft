...
4. Configure and verify the authenticated SMTP mailbox used for invitations and password resets. Production startup requires `SMTP_HOST`, `SMTP_FROM`, `SMTP_USER`, and `SMTP_PASS`; send a reset email through the deployed login screen before launch.
