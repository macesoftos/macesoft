...
function App() {
  ...
  }, [activeModule, isPublicFormView, isSubscriptionRouteView, publicFlipbookToken, publicInvoiceToken, setActiveModule]);
  ...
  useEffect(() => {
    if (typeof document === "undefined" || isPublicFormView || isSubscriptionRouteView || publicFlipbookToken || publicInvoiceToken || isFaceTrackKioskView) return;
  ...
  }, [activeModule, activeRecordTitle, isFaceTrackKioskView, isPublicFormView, isSubscriptionRouteView, publicFlipbookToken, publicInvoiceToken]);
  ...
  return (
    <section className="surface-panel onboarding-automation-panel" aria-label="New client onboarding automation">
      <div className="lead-automation-heading">
        <div><span className="eyebrow">Aesthetic clinic onboarding</span><h3>Welcome, notify, and prepare the client invoice</h3><p>Every external message and invoice uses the subscribing clinic&apos;s branding. ZenshoTech remains the platform, not the customer-facing sender.</p></div>
