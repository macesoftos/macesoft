...
export const subscriptionPlans = Object.freeze([
  monthlyPlan({ code: "starter", name: "Starter", monthlyPrice: 2900, maxUsers: 10, maxBranches: 2, includedWebsitePages: PLAN_WEBSITE_PAGE_ALLOWANCES.starter, displayOrder: 1 }),
  monthlyPlan({ code: "growth", name: "Growth", monthlyPrice: 4900, maxUsers: 15, maxBranches: 4, includedWebsitePages: PLAN_WEBSITE_PAGE_ALLOWANCES.growth, recommended: true, displayOrder: 2 }),
